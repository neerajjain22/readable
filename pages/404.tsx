...
export default function Custom404() {
  ...
  return (
    <Layout>
      <Seo title="Page Not Found | Readable" description="The page you requested could not be found." path="/404" />
      <main className={styles.page}>
        <section className={styles.section}>
          <div className={styles.container}>
            <h1 className={styles.heroTitle}>We couldn't find that page</h1>
            <p className={styles.heroDescription}>
              Try searching for a section or use one of the links below.
            </p>
